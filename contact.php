...
?>
    ...
    <section class="wthree-row pt-3 pb-sm-5 w3-contact">
        <div class="container py-sm-5 pb-5">
            ...
            ?>
            <div class="row contact-form pt-lg-5"><div class="col-lg-6 wthree-form-left">
                    <!-- contact form grid -->
                    <div class="contact-top1">
                        <h5 class="text-dark mb-4 text-capitalize">Send us a note/feedback</h5>
                        <form action="contact_db.php" method="post" class="f-color">
                            <div class="form-group">
                                <label for="contactusername">Name</label>
                                <input type="text" <?php if(isset($_SESSION['email'])) echo 'value="'.$_SESSION['name'].'"' ?>  class="form-control" id="contactusername" name="name" required>
                            </div>
                            <div class="form-group">
                                <label for="contactemail">Email</label>
                                <input type="email" <?php if(isset($_SESSION['email'])) echo 'value="'.$_SESSION['email'].'"' ?>  class="form-control" id="contactemail" name="email" required>
                            </div>
							<div class="form-group">
                                <label for="contactcomment">Your Feedback</label>
                                <textarea class="form-control" rows="5" id="contactcomment" name="feedback" required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="contactcomment">Any Suggestion</label>
                                <textarea class="form-control" rows="5" id="contactcomment" name="suggestion" required></textarea>
                            </div>
                ...
                <!-- contact details -->
                <div class="col-lg-6 contact-bottom p-5 mt-lg-0 mt-5">
                    ...
                    <div class="address mt-md-0 mt-5">
